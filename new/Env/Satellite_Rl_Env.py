...
class BaseSatelliteEnv(gym.Env):
    ...
    def __init__(self, config_file: str, timestep: float = 10.0, max_steps: int = 1000, render: bool = False):
        # Load configuration
        ...
        self.observation_space = spaces.Box(low=-np.inf, high=np.inf, shape=(self.n*9,), dtype=np.float32)
        self.current_step = 0
        self._render = render
...
if __name__ == "__main__":
    env = BaseSatelliteEnv('../satellites_configs/5vs3.yaml', render=False)
